...
data class TrilogyApplicationOptions(
        val testCaseFilePath: String? = null,
        val testProjectPath: String? = null,
        override val shouldSkipSchema: Boolean = false,
        val shouldDisplayHelp: Boolean) : TrilogyOptions {
